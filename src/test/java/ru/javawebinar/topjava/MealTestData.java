...
public class MealTestData {
    ...
    public static final Meal meal4 = new Meal(4, LocalDateTime.of(2020, Month.JANUARY, 31, 0, 0), "Еда на граничное значение", 100);
    ...
    public static Meal getNew() {
        return new Meal(null, LocalDateTime.of(2020, Month.JANUARY, 30, 10, 31), "Завтрак123", 501);
    }
    ...
    public static Meal getUpdated(LocalDateTime localDateTime) {
        Meal updated = new Meal(meal1);
        updated.setCalories(666);
        updated.setDateTime(localDateTime);
